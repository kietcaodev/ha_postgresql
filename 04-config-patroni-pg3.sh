...
# Script: 04-config-patroni-pg3.sh
# Mô tả: Cấu hình Patroni cho node pg3
# Chạy trên: Node pg3
# Lưu ý: File này deprecated, khuyến khích dùng 04-config-patroni.sh thay thế
...
echo "=== Cấu hình Patroni cho node ${NODE_NAME} ==="
...
echo ""
echo "Kiểm tra toàn bộ cluster từ bất kỳ node nào:"
echo "  patronictl -c /etc/patroni/patroni.yml list pg_cluster"
